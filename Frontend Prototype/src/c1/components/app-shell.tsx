...
const NAV = [
  { href: c1Path("/dashboard"), label: "Dashboard", icon: LayoutDashboard },
  { href: c1Path("/children"), label: "Children", icon: Users },
  { href: c1Path("/alerts"), label: "Alerts", icon: Bell },
];
