...
export default function GISMap() {
  ...
  const initialSelected = useMemo(() => {
    if (contextDistrictName) {
      return contextDistricts.find((d) => d.name === contextDistrictName) || contextDistricts[0];
    }
    return contextDistricts[0];
  }, [contextDistrictName, contextDistricts]);
  ...
  const list = contextDistricts
    ...
    .filter((d) => !contextDistrictName || d.name === contextDistrictName)
