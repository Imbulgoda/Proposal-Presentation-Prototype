...
const components = [
  ...
  },
  {
    ...
    subtitle: 'Child-Level Guidance & Clinical Support',
    description:
      'Provides personalized nutrition intervention recommendations based on child-level nutrition information and predicted risk.',
    capabilities: [
