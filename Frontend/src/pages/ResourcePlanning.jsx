      ...
      <div className="space-y-5 p-4 md:p-6">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <ResourceCard
            ...
            value={resourceSummary.totalRequirement.toLocaleString()}
          ...
          <ResourceCard
            ...
            value={resourceSummary.availableStock.toLocaleString()}
              ...
              <div className="px-5 pb-4">
                <div className="h-2 overflow-hidden rounded-full bg-slate-100">
                  <div
                    ...
                    style={{
                      width: `${(resourceSummary.availableStock / resourceSummary.totalRequirement) * 100}%`,
                    }}
                  />
                </div>
              </div>
          ...
          <ResourceCard
            ...
            value={resourceSummary.additionalRequirement.toLocaleString()}
              ...
              <div className="px-5 pb-4">
                <div className="h-2 overflow-hidden rounded-full bg-slate-100">
                  <div
                    ...
                    style={{
                      width: `${(resourceSummary.additionalRequirement / resourceSummary.totalRequirement) * 100}%`,
                    }}
                  />
                </div>
              </div>
            ...
            pdfSections={[
              {
                ...
                lines: [
                  `Total Requirement: ${resourceSummary.totalRequirement}`,
                  `Available Stock: ${resourceSummary.availableStock}`,
                  `Additional Requirement: ${resourceSummary.additionalRequirement}`,
                ],
              },
              {
                heading: 'Allocation',
